...
namespace OmerSeyfettinApp
{
    ...
    public class SmsService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            var header = ConfigurationManager.AppSettings["header"];

            String[] array_tel = new String[] { message.Destination };
            NetGsm.smsnnClient sms_gonder = new NetGsm.smsnnClient();
            String gelen_cevap = sms_gonder.smsGonder1NV2(username, password, header, message.Body, array_tel, "TR", "", "", "", 0);
